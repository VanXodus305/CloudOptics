...
export default function AdminAccountDetails() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/60 backdrop-blur-xl rounded-3xl rounded-tl-none p-8 shadow-xl border border-white flex flex-col items-center flex-grow relative z-0 overflow-hidden min-h-[400px]">
        {/* Background glow */}
        ...
        <div className="w-full flex justify-between items-center mb-8 relative z-10">
          <h2 className="text-xl font-extrabold text-[#111844] tracking-tight">Admin Account details</h2>
          <button className="p-2 bg-white rounded-full shadow-sm border border-gray-100 hover:bg-gray-50 transition-colors text-gray-500 hover:text-[#792CA2]">
        ...
        <div className="flex flex-col items-center gap-4 relative z-10 w-full mt-4">
          ...
          <div className="text-center mt-2">
            <h3 className="text-2xl font-black text-[#111844]">{userName}</h3>
            <p className="text-sm font-medium text-gray-500 mt-1">{userEmail}</p>
          </div>

          <div className="mt-6 bg-white/80 border border-gray-100 rounded-2xl p-4 w-full flex items-center gap-4 shadow-sm">
