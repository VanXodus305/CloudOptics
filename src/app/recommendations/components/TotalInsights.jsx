...
export default function TotalInsights() {
  return (
    <motion.div
      ...
      className="relative overflow-hidden bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-xl border border-white flex flex-col justify-between min-h-[220px]"
    >
      ...
      <div className="relative z-10 mt-6">
        ...
        <p className="text-sm text-gray-500 mt-2 font-medium">
          Implementing these can save approximately <span className="text-[#792CA2] font-bold">$3,240/mo</span>.
        </p>
      </div>
